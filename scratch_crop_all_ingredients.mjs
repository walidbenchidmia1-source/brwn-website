...
async function removeWhiteBg(filename, outputFilename) {
  ...
  try {
    ...
    // Autocrop the transparent edges to fit the circular frame perfectly
    image.autocrop({
      tolerance: 0.002,
...
async function main() {
  await removeWhiteBg('ingredient_strawberry.png', 'ingredient_strawberry_transparent.png');
  await removeWhiteBg('ingredient_mango.png', 'ingredient_mango_transparent.png');
  await removeWhiteBg('ingredient_coconut.png', 'ingredient_coconut_transparent.png');
  await removeWhiteBg('ingredient_lime.png', 'ingredient_lime_transparent.png');
}
